...
var hints = [
	[window.innerWidth, "Presiona ARRIBA y ABAJO para balancear el delfín."],
	[window.innerWidth + 1000, "Presione la barra espaciadora para usar el guión."],
	[window.innerWidth + 2000, "Rebotas contra las capas de hielo"],
	[window.innerWidth + 3000, "Te elevas en géiseres"],
	[window.innerWidth + 4000, "Morirás si tocas montañas o minas."]];
var mountains = [];
var dashCharge = 1;
var lastDashUse = 0;
var alive = true;
...
function update() {
	...
	if (player.x > 50000) {
		pastHistoryUpdate();
		path.innerHTML = "";
		// dialog = ["Hola Padrino[Press E]", "Tengo hambre", "Tengo hambre!", "Tengo hambre", "DON'T PRESS MORE", "?", "You won. Why are you pressing?", "error 13312. don't press more. bip bup.", "", "", "WHY ARE YOU PRESSING"];
		dialog = ["Quieres jugar? [Press E]", "Tengo hambre", "TTengo hambre", "Tengo hambre", "DON'T PRESS ANY MORE", "?", "You have already won. Why are you pressing?", "Error 13312. Don't press any more. Beep boop.", "", "", "WHY ARE YOU PRESSING"];
		left = [0, 2, 0];
		for (var i = 0; i < 9; i++) {
			left.push(1);
		}
